...
## Descrição
Esse projeto tem como objetivo catalogar os diferentes quilombos presentes na região metropolitana de Salvador ao lado de suas características, histórias e demandas. Para servir não só como fonte de informação para pesquisadores e interessados, mas também como meio de denúncia para comunidades que estejam passando por algum tipo de impasse envolvendo suas condições, dando visibilidade a suas histórias e dificuldades.
